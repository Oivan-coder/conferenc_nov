(function () {
    ...
    function publishAgenda() {
        ...
        const talk = (time, n, talkTitle, speaker, photo = '', credentials = '', focus = '50% 28%', showCredentials = false) => `
            <article class="c26-agenda__item agenda-talk">
                ...
                <div>
                    ...
                    <div class="agenda-speaker-row${photo ? '' : ' agenda-speaker-row--text'}">
                        ...
                        <div class="agenda-speaker-copy"><p class="agenda-speaker"><strong>${speaker}</strong>${showCredentials && credentials ? `<span>${credentials}</span>` : ''}</p>${photo ? '<span class="agenda-speaker-hint">Нажмите для подробностей</span>' : ''}</div>
                    </div>
                </div>
            </article>`;
        ...
        agenda.innerHTML = `
            ...
            <div class="agenda-timeline">
                ...
                ${talk('12:40–12:55', '9', 'Текущие и перспективные направления скрининга онкологических заболеваний в регионах', 'Тигран Гагикович Геворкян', 'gevorkyan.webp', 'заместитель директора по реализации федеральных проектов ФГБУ «НМИЦ онкологии им. Н. Н. Блохина» Минздрава России')}
                ...
                ${talk('16:55–17:10', '18', 'Развитие производства медицинских изделий в России: текущие тенденции и перспективы', 'Иконников Михаил Васильевич', 'ikonnikov.webp', 'генеральный директор АО «Эрба Рус»', '50% 28%', true)}
                ...
                ${talk('17:25–17:40', '20', 'ИИ в лаборатории: выявление аномальных назначений и интерпретация исследований', 'Мальцева Мария Аркадьевна', '', 'руководитель направления Центра индустрии здоровья СБЕР', '50% 28%', true)}
